...
public class SubBedTemp : MonoBehaviour
{
    ...
    // thiNgCode: set MQTT topic tool0 = 3D Printer Bed temperature in C
    private string topic = "AR_IoT_combo/thiNg/temperature/bed";
    ...
    void UpdateComponent(){
        ...
        // thiNgCode: using actual as the Bed temperature
        gameObject.GetComponent<Dashboard> ().bedTempVal=sensorData.actual;
